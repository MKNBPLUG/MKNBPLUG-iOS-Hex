...
@implementation MKNBHExcelDataManager

+ (void)exportAppExcel:(id <MKNBHExcelAppProtocol>)protocol
...
+ (void)parseAppExcel:(NSString *)excelName
    ...
    MKNBHExcelWookbook *workbook = [[MKNBHExcelWookbook alloc] initWithExcelFilePathUrl:excelUrl];
    if (!workbook || workbook.sheetArray.count == 0) {
        [self operationFailedBlockWithMsg:@"Load Excel Data Failed" block:failedBlock];
        return;
    }
    MKNBHExcelSheet *sheet = workbook.sheetArray.firstObject;
    if (![sheet isKindOfClass:MKNBHExcelSheet.class]) {
        [self operationFailedBlockWithMsg:@"Load Excel Data Failed" block:failedBlock];
        return;
    }
    ...
    //根据横竖坐标，获取单元格
    //Host
    MKNBHExcelCell *hostCell = [sheet getCellWithColumn:@"B" row:2 error:nil];
    ...
    //Port
    MKNBHExcelCell *portCell = [sheet getCellWithColumn:@"B" row:3 error:nil];
    ...
    //Client id
    MKNBHExcelCell *clientIDCell = [sheet getCellWithColumn:@"B" row:4 error:nil];
    ...
    //Subscribe Topic
    MKNBHExcelCell *subTopicCell = [sheet getCellWithColumn:@"B" row:5 error:nil];
    ...
    //Publish Topic
    MKNBHExcelCell *pubTopicCell = [sheet getCellWithColumn:@"B" row:6 error:nil];
    ...
    //Clean Session
    MKNBHExcelCell *cleanSessionCell = [sheet getCellWithColumn:@"B" row:7 error:nil];
    ...
    //Qos
    MKNBHExcelCell *qosCell = [sheet getCellWithColumn:@"B" row:8 error:nil];
    ...
    //Keep Alive
    MKNBHExcelCell *keepAliveCell = [sheet getCellWithColumn:@"B" row:9 error:nil];
    ...
    //MQTT Username
    MKNBHExcelCell *usernameCell = [sheet getCellWithColumn:@"B" row:10 error:nil];
    ...
    //MQTT Password
    MKNBHExcelCell *passwordCell = [sheet getCellWithColumn:@"B" row:11 error:nil];
    ...
    //SSL/TLS
    MKNBHExcelCell *sslCell = [sheet getCellWithColumn:@"B" row:12 error:nil];
    ...
    //Certificate type
    MKNBHExcelCell *certificateCell = [sheet getCellWithColumn:@"B" row:13 error:nil];
...
+ (void)exportDeviceExcel:(id <MKNBHExcelDeviceProtocol>)protocol
                 sucBlock:(void(^)(void))sucBlock
              failedBlock:(void(^)(NSError *error))failedBlock {
...
+ (void)parseDeviceExcel:(NSString *)excelName
    ...
    [dic setObject:@(certValue) forKey:@"certificate"];
    //LWT
    MKNBHExcelCell *lwtCell = [sheet getCellWithColumn:@"B" row:14 error:nil];
    ...
    //LWT Retain
    MKNBHExcelCell *lwtRetainCell = [sheet getCellWithColumn:@"B" row:15 error:nil];
    ...
    //LWT Qos
    MKNBHExcelCell *lwtQosCell = [sheet getCellWithColumn:@"B" row:16 error:nil];
    ...
    //LWT Topic
    MKNBHExcelCell *lwtTopicCell = [sheet getCellWithColumn:@"B" row:17 error:nil];
    ...
    //LWT Payload
    MKNBHExcelCell *lwtPayloadCell = [sheet getCellWithColumn:@"B" row:18 error:nil];
    ...
    //Device id
    MKNBHExcelCell *deviceIDCell = [sheet getCellWithColumn:@"B" row:19 error:nil];
    ...
    //NTP URL
    MKNBHExcelCell *ntpCell = [sheet getCellWithColumn:@"B" row:20 error:nil];
    ...
    //Timezone
    MKNBHExcelCell *timezoneCell = [sheet getCellWithColumn:@"B" row:21 error:nil];
    ...
    //APN
    MKNBHExcelCell *apnCell = [sheet getCellWithColumn:@"B" row:22 error:nil];
    ...
    //APN Username
    MKNBHExcelCell *apnUsernameCell = [sheet getCellWithColumn:@"B" row:23 error:nil];
    ...
    //APN Password
    MKNBHExcelCell *apnPasswordCell = [sheet getCellWithColumn:@"B" row:24 error:nil];
    ...
    //Network Priority
    MKNBHExcelCell *priorityCell = [sheet getCellWithColumn:@"B" row:25 error:nil];
    ...
    //Debug mode
    MKNBHExcelCell *debugModeCell = [sheet getCellWithColumn:@"B" row:26 error:nil];
...
+ (BOOL)checkExcelAppProtocol:(id <MKNBHExcelAppProtocol>)protocol {
    if (!protocol || ![protocol conformsToProtocol:@protocol(MKNBHExcelAppProtocol)]) {
        return NO;
    }
...
+ (BOOL)checkExcelDeviceProtocol:(id <MKNBHExcelDeviceProtocol>)protocol {
    if (!protocol || ![protocol conformsToProtocol:@protocol(MKNBHExcelDeviceProtocol)]) {
        return NO;
    }
    if (!ValidStr(protocol.host) || protocol.host.length > 64 || ![protocol.host isAsciiString]) {
        return NO;
