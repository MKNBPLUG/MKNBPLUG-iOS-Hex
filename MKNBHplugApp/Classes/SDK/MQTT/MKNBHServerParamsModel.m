...
static NSString *const fileName = @"MKNBHServerParams.txt";

@interface MKNBHServerParamsModel ()
...
@implementation MKNBHServerParamsModel
...
- (BOOL)checkServerDataProtocol:(id <MKNBHServerParamsProtocol>)protocol {
