...
extern NSString *const mk_nbh_peripheralConnectStateChangedNotification;

//Notification of changes in the status of the Bluetooth Center.
extern NSString *const mk_nbh_centralManagerStateChangedNotification;
 ...
 */
extern NSString *const mk_nbh_deviceDisconnectTypeNotification;



@interface MKNBHCentralManager : NSObject<MKBLEBaseCentralManagerProtocol>

@property (nonatomic, weak)id <mk_nbh_centralManagerScanDelegate>delegate;

@property (nonatomic, weak)id <mk_nbh_centralManagerLogDelegate>logDelegate;

/// Current connection status
@property (nonatomic, assign, readonly)mk_nbh_centralConnectStatus connectStatus;
