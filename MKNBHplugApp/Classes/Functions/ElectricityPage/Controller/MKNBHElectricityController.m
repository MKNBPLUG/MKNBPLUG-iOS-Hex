...
@interface MKNBHElectricityController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKNBHElectricityModel *dataModel;

@end

@implementation MKNBHElectricityController

- (void)dealloc {
    NSLog(@"MKNBHElectricityController销毁");
}
...
- (void)loadSectionDatas {
    ...
    cellModel1.leftIcon = LOADICON(@"MKNBHplugApp", @"MKNBHElectricityController", @"nbh_powerPage_voltageIcon.png");
    cellModel1.leftMsg = @"Voltage(V)";
    [self.dataList addObject:cellModel1];
    
    MKNormalTextCellModel *cellModel2 = [[MKNormalTextCellModel alloc] init];
    cellModel2.leftIcon = LOADICON(@"MKNBHplugApp", @"MKNBHElectricityController", @"nbh_powerPage_currentIcon.png");
    cellModel2.leftMsg = @"Current(mA)";
    [self.dataList addObject:cellModel2];
    
    MKNormalTextCellModel *cellModel3 = [[MKNormalTextCellModel alloc] init];
    cellModel3.leftIcon = LOADICON(@"MKNBHplugApp", @"MKNBHElectricityController", @"nbh_powerPage_powerIcon.png");
    cellModel3.leftMsg = @"Power(W)";
    [self.dataList addObject:cellModel3];
    
    MKNormalTextCellModel *cellModel4 = [[MKNormalTextCellModel alloc] init];
    cellModel4.leftIcon = LOADICON(@"MKNBHplugApp", @"MKNBHElectricityController", @"nbh_powerPage_powerFactorIcon.png");
    ...
    cellModel5.leftIcon = LOADICON(@"MKNBHplugApp", @"MKNBHElectricityController", @"nbh_powerPage_frequencyIcon.png");
...
- (MKNBHElectricityModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKNBHElectricityModel alloc] init];
    }
    return _dataModel;
}
