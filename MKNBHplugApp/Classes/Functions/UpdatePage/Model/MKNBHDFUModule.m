...
@interface MKNBHDFUModule()<LoggerDelegate, DFUServiceDelegate, DFUProgressDelegate>
...
@implementation MKNBHDFUModule

- (void)dealloc{
    NSLog(@"MKNBHDFUModule销毁");
}
...
- (void)updateWithFileUrl:(NSString *)url
    ...
    self.dfuController = [initiator startWithTarget:[MKNBHCentralManager shared].peripheral];
}
