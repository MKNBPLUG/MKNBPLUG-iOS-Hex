//
//  MKNBHServerConfigDeviceFooterView.h
...
@interface MKNBHServerConfigDeviceFooterViewModel : NSObject
...
@protocol MKNBHServerConfigDeviceFooterViewDelegate <NSObject>
...
@interface MKNBHServerConfigDeviceFooterView : UIView

@property (nonatomic, strong)MKNBHServerConfigDeviceFooterViewModel *dataModel;

@property (nonatomic, weak)id <MKNBHServerConfigDeviceFooterViewDelegate>delegate;
