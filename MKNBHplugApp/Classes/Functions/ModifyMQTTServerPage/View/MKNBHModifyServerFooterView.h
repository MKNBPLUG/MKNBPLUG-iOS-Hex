...
@interface MKNBHModifyServerFooterViewModel : NSObject
...
/// 0:CA certificate     2:Self signed certificates
...
@protocol MKNBHModifyServerFooterViewDelegate <NSObject>
...
@interface MKNBHModifyServerFooterView : UIView

@property (nonatomic, strong)MKNBHModifyServerFooterViewModel *dataModel;

@property (nonatomic, weak)id <MKNBHModifyServerFooterViewDelegate>delegate;
