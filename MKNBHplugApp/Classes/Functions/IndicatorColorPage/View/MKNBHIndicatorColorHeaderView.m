//
//  MKNBHIndicatorColorHeaderView.m
...
@interface MKNBHIndicatorColorHeaderViewModel : NSObject
...
@implementation MKNBHIndicatorColorHeaderViewModel
@end

@interface MKNBHIndicatorColorHeaderView ()<UIPickerViewDataSource, UIPickerViewDelegate>
...
@implementation MKNBHIndicatorColorHeaderView
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(nullable UIView *)view{
    ...
    MKNBHIndicatorColorHeaderViewModel *model = self.dataList[row];
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component{
    ...
    if ([self.delegate respondsToSelector:@selector(nbh_colorSettingPickViewTypeChanged:)]) {
        [self.delegate nbh_colorSettingPickViewTypeChanged:model.colorType];
    }
}
...
- (void)updateColorType:(NSInteger)colorType {
    ...
    for (NSInteger i = 0; i < self.dataList.count; i ++) {
        MKNBHIndicatorColorHeaderViewModel *model = self.dataList[i];
...
- (void)loadPickViewDatas {
    MKNBHIndicatorColorHeaderViewModel *transitionDirectlyModel = [[MKNBHIndicatorColorHeaderViewModel alloc] init];
    ...
    MKNBHIndicatorColorHeaderViewModel *transitionSmoothlyModel = [[MKNBHIndicatorColorHeaderViewModel alloc] init];
    ...
    MKNBHIndicatorColorHeaderViewModel *whiteModel = [[MKNBHIndicatorColorHeaderViewModel alloc] init];
    whiteModel.colorMsg = @"White";
    whiteModel.colorType = 2;
    [self.dataList addObject:whiteModel];
    
    MKNBHIndicatorColorHeaderViewModel *redModel = [[MKNBHIndicatorColorHeaderViewModel alloc] init];
    redModel.colorMsg = @"Red";
    redModel.colorType = 3;
    [self.dataList addObject:redModel];
    
    MKNBHIndicatorColorHeaderViewModel *greenModel = [[MKNBHIndicatorColorHeaderViewModel alloc] init];
    greenModel.colorMsg = @"Green";
    greenModel.colorType = 4;
    [self.dataList addObject:greenModel];
    
    MKNBHIndicatorColorHeaderViewModel *blueModel = [[MKNBHIndicatorColorHeaderViewModel alloc] init];
    blueModel.colorMsg = @"Blue";
    blueModel.colorType = 5;
    [self.dataList addObject:blueModel];
    
    MKNBHIndicatorColorHeaderViewModel *orangeModel = [[MKNBHIndicatorColorHeaderViewModel alloc] init];
    orangeModel.colorMsg = @"Orange";
    orangeModel.colorType = 6;
    [self.dataList addObject:orangeModel];
    
    MKNBHIndicatorColorHeaderViewModel *cyanModel = [[MKNBHIndicatorColorHeaderViewModel alloc] init];
    cyanModel.colorMsg = @"Cyan";
    cyanModel.colorType = 7;
    [self.dataList addObject:cyanModel];
    
    MKNBHIndicatorColorHeaderViewModel *purpleModel = [[MKNBHIndicatorColorHeaderViewModel alloc] init];
