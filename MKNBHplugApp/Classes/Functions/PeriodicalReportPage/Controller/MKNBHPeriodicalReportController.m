//
//  MKNBHPeriodicalReportController.m
...
@interface MKNBHPeriodicalReportController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKNBHPeriodicalReportModel *dataModel;

@end

@implementation MKNBHPeriodicalReportController

- (void)dealloc {
    NSLog(@"MKNBHPeriodicalReportController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKNBHplugApp", @"MKNBHPeriodicalReportController", @"nbh_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKNBHPeriodicalReportModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKNBHPeriodicalReportModel alloc] init];
    }
    return _dataModel;
}
