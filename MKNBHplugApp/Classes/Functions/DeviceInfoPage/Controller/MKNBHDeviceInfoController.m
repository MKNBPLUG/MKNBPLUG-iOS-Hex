...
@interface MKNBHDeviceInfoController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKNBHDeviceInfoModel *dataModel;

@end

@implementation MKNBHDeviceInfoController

- (void)dealloc {
    NSLog(@"MKNBHDeviceInfoController销毁");
}
...
- (MKNBHDeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKNBHDeviceInfoModel alloc] init];
    }
    return _dataModel;
}
