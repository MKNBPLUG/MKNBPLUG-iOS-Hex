...
@interface MKNBHImportServerController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MKNBHImportServerController

- (void)dealloc {
    NSLog(@"MKNBHImportServerController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.delegate respondsToSelector:@selector(nbh_selectedServerParams:)]) {
        [self.delegate nbh_selectedServerParams:model.leftMsg];
    }
