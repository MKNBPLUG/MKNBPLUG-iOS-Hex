...
@implementation MKNBHCountdownPickerViewModel
@end

@interface MKNBHCountdownPickerView()<UIPickerViewDataSource, UIPickerViewDelegate>
...
@property (nonatomic, copy)void (^timePickerBlock)(MKNBHCountdownPickerViewModel *timeModel);
...
@implementation MKNBHCountdownPickerView

- (void)dealloc{
    NSLog(@"MKNBHCountdownPickerView销毁");
}
