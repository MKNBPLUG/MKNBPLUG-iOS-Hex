...
@interface MKNBHSettingPageBleModel ()<mk_nbh_centralManagerScanDelegate>
...
@implementation MKNBHSettingPageBleModel

- (void)dealloc {
    NSLog(@"MKNBHSettingPageBleModel销毁");
}
...
- (void)mk_nbh_receiveDevice:(NSDictionary *)deviceModel {
    ...
    [[MKNBHCentralManager shared] connectPeripheral:deviceModel[@"peripheral"] sucBlock:^(CBPeripheral * _Nonnull peripheral) {
