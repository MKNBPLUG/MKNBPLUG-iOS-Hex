...
@implementation MKNBHEasyShowView
...
- (void)showText:(NSString *)text
    ...
    if (animated) {
        ...
        [self.refreshIcon.layer addAnimation:[MKCustomUIAdopter refreshAnimation:1.f]
                                      forKey:@"mk_nbh_refreshAnimation"];
    }else {
...
- (UIImageView *)refreshIcon {
    if (!_refreshIcon) {
        ...
        _refreshIcon.image = LOADICON(@"MKNBHplugApp", @"MKNBHEasyShowView", @"nbh_refreshIcon.png");
    }
    return _refreshIcon;
}
