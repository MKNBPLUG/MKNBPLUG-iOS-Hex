...
@implementation MKNBHAddDeviceView
...
- (UIImageView *)centerIcon{
    if (!_centerIcon) {
        ...
        _centerIcon.image = LOADICON(@"MKNBHplugApp", @"MKNBHAddDeviceView", @"nbh_deviceList_centerIcon.png");
    }
    return _centerIcon;
}
