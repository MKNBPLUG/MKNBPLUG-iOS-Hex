//
//  MKNBHConnectSuccessController.m
...
@interface MKNBHConnectSuccessController ()
...
@implementation MKNBHConnectSuccessController

- (void)dealloc {
    NSLog(@"MKNBHConnectSuccessController销毁");
}
...
- (void)saveButtonPressed {
    ...
    [MKNBHDeviceListDatabaseManager insertDeviceList:@[self.deviceModel] sucBlock:^{
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_nbh_addNewDeviceSuccessNotification"
                                                            object:nil
