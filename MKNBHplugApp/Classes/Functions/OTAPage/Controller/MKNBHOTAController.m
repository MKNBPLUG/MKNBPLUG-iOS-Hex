...
@interface MKNBHOTAController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKNBHOTADataModel *dataModel;

@property (nonatomic, strong)UIButton *typeButton;

@end

@implementation MKNBHOTAController

- (void)dealloc {
    NSLog(@"MKNBHOTAController销毁");
...
- (MKNBHOTADataModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKNBHOTADataModel alloc] init];
    }
    return _dataModel;
}
