...
@interface MKNBHEnergyDailyView ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation MKNBHEnergyDailyView

- (void)dealloc {
    NSLog(@"MKNBHEnergyDailyView销毁");
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self
                                                 selector:@selector(receiveDailyDatas:)
                                                     name:MKNBHReceiveMonthlyEnergyDataNotification
                                                   object:nil];
    }
    return self;
}
